...
static const int textsystray =
    1; /* 1 means use text instead of icons for system trays */
typedef struct {
  const char *class_name;
  const char *icon;
} trayIcon;
static const trayIcon icons[] = {
    {"discord", "ﭮ"}, {"steam", ""}, {"nm-tray", "ﯱ"}, {"?", ""}};
...
static unsigned int gappoh =
    24; /* horiz outer gap between windows and screen edge */
static unsigned int gappov =
    24; /* vert outer gap between windows and screen edge */
...
static char ffont[] = "GohuFont 14 Nerd Font Mono:size=10:antialias=false";
static char *fonts[] = {
    "JetBrainsMono Nerd Font:size=10:antialias=true",
    "Noto Color Emoji:pixelsize=10:antialias=true:autohint=true",
    "FontAwesome:size=12:antialias=true",
    "Noto Sans Mono CJK JP:size=10:antialias=false"};
...
static unsigned const int alphas[][3] = {
    /*               fg      bg        border*/
...
const char *spcmd2[] = {TERMINAL, "-n", "top",  "-g",
                        "100x40", "-e", "btop", NULL};
const char *spcmd3[] = {TERMINAL, "-n", "ranger", "-g",
                        "100x40", "-e", "ranger", NULL};
const char *spcmd4[] = {TERMINAL, "-n", "musikcube", "-g",
                        "100x40", "-e", "musikcube", NULL};
const char *spcmd5[] = {"albumart.sh", NULL};
const char *spcmd6[] = {TERMINAL,       "-n", "cavaviz", "-g",
                        "40x18+59+472", "-e", "cava",    NULL};
static Sp scratchpads[] = {
    /* name          cmd  */
    {"spterm", spcmd1},    {"top", spcmd2},      {"spranger", spcmd3},
    {"musikcube", spcmd4}, {"albumart", spcmd5}, {"cavaviz", spcmd6},
};
...
static const Rule rules[] = {
     ...
     */
    /* class    instance      title          tags mask    isfloating isfreesize
       isterminal noslwallow monitor */
    ...
    {"Brave-browser", NULL, NULL, 1 << 2, 0, 0, 0, 0, -1},
...
static const int attachdirection =
    4; /* 0 default, 1 above, 2 aside, 3 below, 4 bottom, 5 top */
#define FORCE_VSPLIT                                                           \
...
ResourcePref resources[] = {
    ...
    {"dwm.swallowfloating", INTEGER, &swallowfloating},
...
static Key keys[] = {
    ...
    {MODKEY, XK_p, spawn,
     SHCMD("playerctl play-pause; sleep 0.4; pkill -RTMIN+14 dwmblocks")},
    {MODKEY | ShiftMask, XK_p, spawn,
     SHCMD("playerctld shift; pkill -RTMIN+14 dwmblocks")},
    {MODKEY, XK_bracketleft, spawn, SHCMD("playerctl position 10-")},
    {MODKEY | ShiftMask, XK_bracketleft, spawn,
     SHCMD("playerctl position 60-")},
    ...
    {MODKEY | ShiftMask, XK_d, spawn,
     SHCMD("j4-dmenu-desktop --dmenu=\"dmenu -l 10 -g 5\"")},
    ...
    // }, { MODKEY|ShiftMask,			XK_z,		incrogaps,
    // {.i = +3 } },
    ...
    {MODKEY, XK_comma, spawn,
     SHCMD("playerctl previous; pkill -RTMIN+14 dwmblocks")},
    {MODKEY | ShiftMask, XK_comma, spawn, SHCMD("playerctl position 0")},
    {MODKEY, XK_period, spawn,
     SHCMD("playerctl next; pkill -RTMIN+14 dwmblocks")},
    ...
    // }, { MODKEY|ShiftMask,		XK_Page_Up,	shifttag,	{ .i =
    // -1 } },
    // { MODKEY,			XK_Page_Down,	shiftview,	{ .i = +1 }
    // }, { MODKEY|ShiftMask,		XK_Page_Down,	shifttag,	{ .i =
    // +1 } },
    ...
    {MODKEY, XK_F11, spawn,
     SHCMD("mpv --no-cache --no-osc --no-input-default-bindings --vf=hflip "
    ...
    {0, XF86XK_AudioPrev, spawn,
     SHCMD("playerctl previous; kill -44 $(pidof dwmblocks)")},
    {0, XF86XK_AudioNext, spawn,
     SHCMD("playerctl next; kill -44 $(pidof dwmblocks)")},
    {0, XF86XK_AudioPause, spawn,
     SHCMD("playerctl pause; kill -44 $(pidof dwmblocks)")},
    {0, XF86XK_AudioPlay, spawn,
     SHCMD("playerctl play; kill -44 $(pidof dwmblocks)")},
    {0, XF86XK_AudioStop, spawn,
     SHCMD("playerctl stop; kill -44 $(pidof dwmblocks)")},
    ...
    {0, XF86XK_ScreenSaver, spawn,
     SHCMD("slock & xset dpms force off; playerctl -a pause")},
    ...
    {ControlMask | ShiftMask, XK_space, spawn,
     SHCMD("dunstctl set-paused toggle")},
 ...
 */
    ...
    {ClkStatusText, ShiftMask, Button3, spawn,
     SHCMD(TERMINAL " -e nvim ~/src/dwmblocks/config.h")},
